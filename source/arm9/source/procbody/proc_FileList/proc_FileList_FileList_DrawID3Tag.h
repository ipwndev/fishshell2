...
u16* FileList_DrawID3Tag_asm_Fill25per(u16 *pbuf,u32 size)
{
	asm volatile (
...
u16* FileList_DrawID3Tag_asm_Fill50per(u16 *pbuf,u32 size)
{
	asm volatile (
	"stmfd sp!, {r4,r5,r6,lr} \n\t"
	" \n\t"
...
static void FileList_DrawID3Tag(CglCanvas *pDstBM,bool DrawFrame)
{
  ...
  u32 x=8,y=4,h=glCanvasTextHeight+2;
