...
DATA_IN_IWRAM_TextView static u32 Popup_TimeoutVSync;

DATA_IN_IWRAM_TextView static TRect PopupRect={16,16,0,16};
...
{
    char str[32];
    snprintf(str,32,Lang_GetUTF8("TV_Popup_BacklightLevel"),1+ProcState.System.BacklightLevel);
    Popup_Show(str);
}

static void Popup_Show_Boomark_Load(void)
{
    Popup_Show(Lang_GetUTF8("TV_Popup_Bookmark_Load"));
}

static void Popup_Show_Boomark_Empty(void)
{
    Popup_Show(Lang_GetUTF8("TV_Popup_Bookmark_Empty"));
}

static void Popup_Show_Boomark_Save(void)
{
    Popup_Show(Lang_GetUTF8("TV_Popup_Bookmark_Save"));
}

static void Popup_Show_MP3Cnt_Pause(void)
{
    if(PlayList_GetPause()==false){
        Popup_Show(Lang_GetUTF8("TV_Popup_Pause_Play"));
    }else{
        Popup_Show(Lang_GetUTF8("TV_Popup_Pause_Pause"));
    }
}

static void Popup_Show_MP3Cnt_Prev(void)
{
    Popup_Show(Lang_GetUTF8("TV_Popup_PreviousFile"));
}

static void Popup_Show_MP3Cnt_Next(void)
{
    Popup_Show(Lang_GetUTF8("TV_Popup_NextFile"));
}
...
static void Popup_Show_MP3Cnt_Seek(s32 val)
{
    ...
    snprintf(str,32,Lang_GetUTF8("TV_Popup_Seek"),valstr);

    Popup_Show(str);
}

static void Popup_Show_MoveToTop(void)
{
    Popup_Show(Lang_GetUTF8("TV_Popup_MoveToTop"));
}

static void Popup_Show_MoveToLast(void)
{
    Popup_Show(Lang_GetUTF8("TV_Popup_MoveToLast"));
}
