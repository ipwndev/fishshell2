...
extern FAT_FILE *readFunc_FileHandle;

#define READ(_gif,_buf,_len) \
  FAT2_fread(_buf,1,_len,readFunc_FileHandle)
...
/*
_consolePrintOne("c:GifFile=%x\n",(int)GifFile);
_consolePrintOne("c:&Image.ColorMap=%x\n",&GifFile->Image.ColorMap);
_consolePrintOne("c:&SColorMap=%x\n",&GifFile->SColorMap);
*/
