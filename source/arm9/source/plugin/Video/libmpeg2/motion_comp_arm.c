...
static CODE_IN_ITCM_DPG void inline MC_##op##_##xy##_16_c (uint8_t * dest, const uint8_t * ref,	\
...
static CODE_IN_ITCM_DPG void MC_put_y_16_arm (uint8_t * dest, const uint8_t * ref, int stride, int height)
{
  MC_put_y_16_c(dest, ref, stride, height);
}

static CODE_IN_ITCM_DPG void MC_put_xy_16_arm (uint8_t * dest, const uint8_t * ref, int stride, int height)
{
  MC_put_xy_16_c(dest, ref, stride, height);
}

static CODE_IN_ITCM_DPG void MC_put_y_8_arm (uint8_t * dest, const uint8_t * ref, int stride, int height)
{
  MC_put_y_8_c(dest, ref, stride, height);
}

static CODE_IN_ITCM_DPG void MC_put_xy_8_arm (uint8_t * dest, const uint8_t * ref, int stride, int height)
{
